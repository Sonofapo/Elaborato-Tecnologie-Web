...
<main>
	<div id="accordion">
		<section id="alerts">
			...
			<div id="alerts-body" class="container collapse pb-3" data-bs-parent="#accordion">
				<ul>
		...
		<section id="orders">
			<a class="collapsed" href="#orders-body" data-bs-toggle="collapse" title="ordini">
				<h2>
					<?php 
					if($vars["isVendor"])
						echo count($vars["orders"]) ? "Ordini processati" : "Non ci sono ordini";
					else
						echo count($vars["orders"]) ? "I tuoi Ordini" : "Non ci sono ordini";
					?>
				</h2>
			</a>
